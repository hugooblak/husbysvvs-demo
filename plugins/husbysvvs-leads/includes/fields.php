...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'husbysvvs-leads' ),
				'storm'       => __( 'Storm or hail damage', 'husbysvvs-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'husbysvvs-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'husbysvvs-leads' ),
				'not-sure'    => __( 'Vet inte än', 'husbysvvs-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'husbysvvs-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'husbysvvs-leads' ),
				'research' => __( 'Jag kollar bara priser', 'husbysvvs-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'husbysvvs-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'husbysvvs-leads' ),
		'contacted' => __( 'Kontaktad', 'husbysvvs-leads' ),
		'quoted'    => __( 'Quote sent', 'husbysvvs-leads' ),
		'won'       => __( 'Won', 'husbysvvs-leads' ),
		'lost'      => __( 'Lost', 'husbysvvs-leads' ),
		'spam'      => __( 'Misstänkt spam', 'husbysvvs-leads' ),
	);
}
