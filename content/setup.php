<?php
/**
 * Demo site setup for Husbys VVS AB.
 *
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Husbys VVS AB' );
...
$home = nps_page(
	...
	nps_pattern( 'husbysvvs/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'husbysvvs/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'husbysvvs/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'husbysvvs/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'husbysvvs/thank-you' ),
...
<p class="has-large-font-size">Husbys VVS AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Husbys VVS AB', $about_content . "\n\n" . nps_pattern( 'husbysvvs/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'husbysvvs/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Husbys VVS AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'Husbys VVS AB demo ready.' );
